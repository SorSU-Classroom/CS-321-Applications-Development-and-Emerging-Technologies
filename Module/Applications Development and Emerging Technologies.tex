...
within an element. The text can be aligned to the left, right, center, or
justified.
...
text within an element. The text can be transformed to uppercase, lowercase,
capitalize, or none.
...
\textbf{<div>} elements is set to block, inline, and flex, creating different
display behaviors for the elements.
...
\textbf{<div>} elements is set to 1fr, 2fr, and 1fr, creating different grid
behaviors for the elements.
...
\textbf{<button>} element is changed to lightcoral when the mouse hovers over
it.
...
\textbf{<button>} element is changed to lightcoral and the scale is increased
when the mouse hovers over it, creating a smooth transition effect.
