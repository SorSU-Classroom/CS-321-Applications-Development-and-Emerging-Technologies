...
static value is the default value and does not affect the position of the
element.
...
\textbf{<div>} element is set to static, which is the default value.
...
\textbf{position} property with a value of relative. In this example, the
position of the \textbf{<div>} element is set to relative, and the top and left
properties are used to offset the element by 10 pixels.
...
\textbf{position} property with a value of absolute. In this example, the
position of the \textbf{<div>} elements is set to absolute, and the top, right,
...
\textbf{position} property with a value of fixed. In this example, the position
of the \textbf{<div>} element is set to fixed, and the top and right properties
are used to position the element on the screen.
...
\textbf{position} property with a value of sticky. In this example, the
position of the \textbf{<div>} element is set to sticky, and the top property
is used to position the element on the screen.
...
\textbf{<input>} element is changed to lightcoral when it receives focus.
